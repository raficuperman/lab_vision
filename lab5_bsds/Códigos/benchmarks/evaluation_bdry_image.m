...
%             - a collection of segmentations in a cell 'tamanoOriginal' stored in a mat file
...
if exist('ucm2', 'var'),
    ...
    clear ucm2;
elseif ~exist('tamanoOriginal', 'var')
...
for t = 1:nthresh,
    ...
    if ~exist('tamanoOriginal', 'var')
        ...
        bmap = logical(seg2bdry(tamanoOriginal{t},'imageSize'));
    end
